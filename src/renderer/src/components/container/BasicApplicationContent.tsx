...
function Unauthorized() {
    ...
    return (
        <div className="flex flex-col justify-center items-center h-full gap-2">
            ...
            <button
                className="rounded-lg px-3 py-2 mt-3 bg-secondary text-secondary flex items-center justify-start hover:text-special transition-colors duration-300 cursor-pointer"
